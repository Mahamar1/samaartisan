                ...
                <div className="text-center py-10 space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-slate-600 max-w-md mx-auto leading-relaxed">
                      Merci <strong>{fullName}</strong>. Votre demande a été enregistrée et transmise par email à l'administrateur. Nous vous recontacterons au <strong>{phone}</strong> dans les plus brefs délais.
                    </p>
                  </div>
