        ...
        <div className="flex items-center justify-between h-16 sm:h-20 gap-2">
          ...
          <div className="flex items-center gap-1.5 sm:gap-3 shrink-0">
            {sessionUser ? (
              ...
              /* Vue Déconnectée : Boutons Connexion et Inscription */
              <div className="flex items-center gap-2">
                <Link
                  href="/connexion"
                  className="flex items-center gap-1.5 px-3 py-2 sm:px-4 sm:py-2 rounded-xl text-xs sm:text-sm font-bold bg-slate-100 hover:bg-slate-200 text-navy-900 border border-slate-200/80 transition-all active:scale-95 shrink-0"
                  title="Se connecter (Espace Client ou Espace Artisan)"
                >
                  <LogIn className="w-3.5 h-3.5 text-sama-600 stroke-[2.5]" />
                  <span>Connexion</span>
                </Link>

                <Link
                  href="/inscription"
                  className="flex items-center gap-1.5 px-3.5 py-2 sm:px-4 sm:py-2 rounded-xl text-xs sm:text-sm font-bold bg-sama-600 hover:bg-sama-500 text-white shadow-md shadow-sama-600/20 transition-all active:scale-95 shrink-0"
                  title="Créer un compte client ou artisan"
                >
