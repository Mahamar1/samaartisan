...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    slug: "informaticien",
    iconName: "Monitor",
    description: "Services professionnels d'Informaticien qualifié et vérifié au Sénégal (Dépannage PC, maintenance informatique, installation logiciels et systèmes).",
    shortDesc: "Dépannage, maintenance informatique et assistance technique à Dakar",
    providerCount: 24,
    popularKeywords: ["informaticien", "informaticien dakar", "dépannage pc dakar", "réparation ordinateur"],
  ...
  },
  {
    ...
    slug: "technicien-reseau",
    iconName: "Zap",
    description: "Services professionnels de Technicien Réseau qualifié et vérifié au Sénégal (Câblage structuré, baies de brassage, routeurs, Wi-Fi d'entreprise et fibre).",
    shortDesc: "Installation, câblage réseau RJ45 et configuration Wi-Fi à Dakar",
    providerCount: 19,
    popularKeywords: ["réseau informatique", "technicien réseau dakar", "câblage réseau dakar", "installation wifi"],
  ...
  },
  {
    ...
    iconName: "Tv",
    description: "Services professionnels d'Installateur de Caméras de Surveillance qualifié et vérifié au Sénégal (Systèmes CCTV, caméras IP, vision nocturne, enregistreurs DVR/NVR).",
    shortDesc: "Installation de caméras de surveillance IP/CCTV et sécurité vidéo à Dakar",
    providerCount: 27,
    popularKeywords: ["caméra de surveillance", "installation caméra dakar", "caméra ip dakar", "sécurité vidéo"],
    bannerImage: "https://images.unsplash.com/photo-1557597774-9d273605dfa9?auto=format&fit=crop&w=1200&q=80",
    averageStartingPrice: 35000,
  },
  {
    id: "visiophone-videophone",
    name: "Installation Visiophone / Vidéophone",
    slug: "visiophone-videophone",
    iconName: "Smartphone",
    description: "Services professionnels d'Installateur de Visiophones et Vidéophones qualifiés au Sénégal (Interphones vidéo, contrôle d'accès, gâche électrique et portiers vidéo).",
    shortDesc: "Installation de visiophones, vidéophones et portiers vidéo intelligents à Dakar",
    providerCount: 18,
    popularKeywords: ["visiophone dakar", "vidéophone", "installation interphone dakar", "portier vidéo"],
    bannerImage: "https://images.unsplash.com/photo-1558002038-1055907df827?auto=format&fit=crop&w=1200&q=80",
    averageStartingPrice: 30000,
  }
];
